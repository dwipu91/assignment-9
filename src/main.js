//let peoplePost = document.querySelector(".peoplePost");
let list_item = "";
peoplePost.map((item, index) => {
	list_item += `<div class="user-post">
...
peoplePost.innerHTML = list_item;
